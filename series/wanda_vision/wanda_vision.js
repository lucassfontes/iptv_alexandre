...
import {capa_eps, capa_video} from './wanda_vision_capa.js'

import {s1_eps_,} from './wanda_vision_temp_eps.js'

// Triler

let triler = document.getElementById('triler')

    triler.poster = 'https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/498A4C644BC48D8A29039338314CA343B48D57275FEC7E3F2F12A0383B0789F1/scale?width=1200&aspectRatio=1.78&format=jpeg'

    triler.src = 'https://br.vid.web.acsta.net/uk/medias/nmedia/55/20/09/24/17//19564109_hd_013.mp4'

    triler.title = 'Wanda Vision'
    triler.alt = 'Wanda Vision'
