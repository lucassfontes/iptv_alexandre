...
import {capa_eps, capa_video} from './expresso_amanha_capa.js'

import {s1_eps_, s2_eps_} from './expresso_temp_eps.js'

// Triler

let triler = document.getElementById('triler')

    triler.poster = 'https://oc2-0-767-1335.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABck2lTqVpya4XivwKsn5hEVmE4cAr3P4y4OHNcsozqXyQ7c5s6phBlndVApZ5A7XGN378fmnyjlYvhupgBSsf5MExpfdfIOeO-FF8-2WBWMhSB65nr3rv9SK0CQcew.jpg?r=6c2'

    triler.src = 'https://br.vid.web.acsta.net/uk/medias/nmedia/55/20/05/14/23//19563684_hd_013.mp4'

    triler.title = 'Expresso do Amanhã'
    triler.alt = 'Expresso do Amanhã'
