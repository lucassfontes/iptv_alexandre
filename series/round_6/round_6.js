...
import {capa_eps, capa_video} from './round_6_capa.js'

import {s1_eps_,} from './round_6_temp_eps.js'

// Triler

let triler = document.getElementById('triler')

    triler.poster = 'https://oc2-0-767-1335.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABReYTAS3KP6hra7TTCurMUFYAozilA2mnTSAg5DfqJk3mZ8S2gV-v7KFTFl5piepQswyNN_PvRZEUpSdibE8zQlAV9G-srZzmlgNEIQlel-Ed1puW4CSPEPkUBNn.jpg?r=d24'

    triler.src = 'https://br.vid.web.acsta.net/uk/medias/nmedia/55/21/09/14/18/19565306_hd_013.mp4'

    triler.title = 'Round 6'
    triler.alt = 'Round 6'
